...
```shell-session
cyberslut@NIX02:~$ echo $PATH

/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games
```

```shell-session
cyberslut@NIX02:~$ PATH=.:${PATH}
cyberslut@NIX02:~$ export PATH
cyberslut@NIX02:~$ echo $PATH
...
```shell-session
cyberslut@NIX02:~$ touch ls
cyberslut@NIX02:~$ echo 'echo "PATH ABUSE!!"' > ls
cyberslut@NIX02:~$ chmod +x ls
```
